...
Jurisdiction.prototype = {
	...
	addRecords: function(){
		return this.addNotice.get("add") || new BigNumber(0);;
	},
	
	updateRecords: function(){
		return this.updateNotice.get("update") || new BigNumber(0);;
	},
	
	delRecords: function(){
		return this.delNotice.get("del") || new BigNumber(0);;
	},
	...
	//能够查询当前的已经有哪些地址计算在和权重里面了
    //  所有没有超过50的，不报错，但是可以有返回值或者直接执行到最后	
